			...
			<div class="row justify-content-md-center">
				<article class="col-12 col-md-8">
					<header class="mb-4">
						...
						<h2 class="mb-3 pb-3"><?php the_excerpt(); ?></h2>
					...
					<footer class="mb-5">
						<div class="pa-post-navigation row mt-4">
							...
							<div class="pa-post-prev col-6 col-xl-3 order-xl-1 text-left">
								<?php if($prev_post): ?>
									<a href="<?php echo get_permalink($prev_post->ID); ?>"><i class="fas fa-arrow-left"></i><?=  _e('Previous article', 'iasd'); ?></a>
								<?php endif; ?>
							</div>
							<div class="pa-post-next col-6 col-xl-3 order-xl-3 text-right">
								<?php if($next_post): ?>
									<a href="<?php echo get_permalink($next_post->ID); ?>"><?= _e('Next article', 'iasd'); ?><i class="fas fa-arrow-right"></i></a>
								<?php endif; ?>
							</div>
						</div>
						<?php 
