...
- Novos textos e traduções do bloco Encontre uma igreja em português (pt_BR) e espanhol (es_ES).
...
- Ajuste da tradução de blocos

## [1.6.1] - 2025-08-29
### Fix

- Melhorias do custom post type notas oficiais
...
- Criação de custom post type 'notas oficiais'
...
- Abilitando os módulos como verdadeiro por defalt
