		...
		<div class="container">
			<div class="row justify-content-md-center">
				<section class="col-12 col-xl-8">
					...
					<?php 
						// Pega o último post publicado para destaque
						if(get_query_var('paged') < 1 && $wp_query->found_posts > 0):
							$posts = $wp_query->posts;
							$destaque = $posts[0]; // primeiro da lista
							
							get_template_part('template-parts/global/feature', 'feature', [
								'post' => $destaque,
								'tag'  => $format = get_post_format($destaque) ? : __('News', 'iasd'),
							]); 
							
							// remove o destaque da lista de posts
							unset($posts[0]);
						endif;
					?>
							...
							<?php 
								foreach($posts as $post):
									get_template_part('template-parts/global/card-post', 'card-post', [
										...
										'format'   => get_post_format($post) ? : __('Notas Oficiais', 'iasd'),
									]); 
								endforeach; 
							?>
						</div>
